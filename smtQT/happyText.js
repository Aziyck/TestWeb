function initparticles() {
 ...
 function confetti() {
    $.each($(".particletext.confetti"), function(){
       ...
       for(var i = 0; i <= confetticount; i++) {
          $(this).append('<span class="particle c' + $.rnd(1,4) + '" style="top:' + $.rnd(20,80) + '%; left:' + $.rnd(0,100) + '%;width:' + $.rnd(10,15) + 'px; height:' + $.rnd(1,6) + 'px;animation-delay: ' + ($.rnd(0,30)/10) + 's;"></span>');
       }
    });
 }
 ...
 function confettiTwo() {
   $.each($(".particletext.confettiTwo"), function(){
      var confetticount = ($(this).width()/50)*10;
      for(var i = 0; i <= confetticount; i++) {
         $(this).append('<span class="particle c' + $.rnd(1,4) + '" style="top:' + $.rnd(20,30) + '%; left:' + $.rnd(0,100) + '%;width:' + $.rnd(6,12) + 'px; height:' + $.rnd(3,8) + 'px;animation-delay: ' + ($.rnd(0,30)/10) + 's;"></span>');
      }
   });
}
